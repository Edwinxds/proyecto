		...
		<tr>
			...
			<td class="info_empresa">
				...
				<div>
					...
					<p>Cedula/Rif: <?php echo $configuracion['RIF']; ?></p>
					<p>Teléfono: <?php echo "0".$configuracion['telefono']; ?></p>
				...
				<div class="round">
					...
					<table class="datos_cliente">
						<tr>
							...
							<td><label>Teléfono:</label> <p><?php echo "0".$factura['telefono']; ?></p></td>
						</tr>
						<tr>
			...
			<?php
			 ...
			 ?>
				<tr>
					...
					<td class="textright"><?php echo $row['precio_venta']." BS"; ?></td>
					<td class="textright"><?php echo number_format($row['precio_total'], 2)." BS"; ?></td>
